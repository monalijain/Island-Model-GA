...
def Make_Performance_Measures(Begin,End,Train_Or_Report,walkforward_number,islandID, dbObject1):
    ...
    resultDates = dbObject1.dbQuery("SELECT DISTINCT(date),1 FROM "+ ip.priceSeriesTable +" WHERE date >= '" + str(BeginDate.date()) + "' AND date <= '"+ str(EndDate.date()) +"'")
    #dbObject2.dbClose()
...
if __name__ == '__main__':
    dbObject1=Diff_DBUtils()
    dbObject1.dbConnect("island1")
    Make_Performance_Measures('20120402','20120430',"Training",1,1,dbObject1)