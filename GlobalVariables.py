...
name_database='individualinfo_ver3'#'individualinfo_ver3' # Name of the database where, PriceSeries.csv and name_Tradesheet_table is stored
db_username = 'root'
db_password = 'controljp'#'controljp'
db_host = '127.0.0.1'
db_port = '3306'
